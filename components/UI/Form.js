...
async function  Form () {
    ...
    if (res.status === 200) {
      ...
      console.log("historyId res", historyId);
...
<div className="mr-10" >
<h2 className="text-4xl font-bold dark:text-white mb-10">Create a New Song</h2>
  ...
  <button onClick={()=>submitHandler()} type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Upload</button>
</div>
